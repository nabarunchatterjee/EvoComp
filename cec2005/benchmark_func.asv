...
% 	3.Shifted Rotated High Conditioned Elliptic Function ::: Shift
% 	eliminated
...
%%%%%%%%%%%%%Multimodal%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 	6.Shifted Rosenbrock's Function   :: Shift eliminated
...
% 	7.Shifted Rotated Griewank's Function  : shift eliminated
...
% 	8.Shifted Rotated Ackley's Function with Global Optimum on Bounds 	::bias eliminated
...
% 	9.Shifted Rastrign's Function    : shift eliminated
...
% 	10.Shifted Rotated Rastrign's Function  : Shift eliminated
...
% 	11.Shifted Rotated Weierstrass Function   :shift eliminated
